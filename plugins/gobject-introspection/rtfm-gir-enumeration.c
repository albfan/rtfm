...
G_DEFINE_TYPE (RtfmGirEnumeration, rtfm_gir_enumeration, RTFM_GIR_TYPE_PARSER_OBJECT)
...
static GPtrArray *
rtfm_gir_enumeration_get_children (RtfmGirParserObject *object)
{
  RtfmGirEnumeration *self = (RtfmGirEnumeration *)object;

  g_assert (RTFM_GIR_IS_ENUMERATION (self));
...
rtfm_gir_enumeration_end_element (GMarkupParseContext *context,
                                  ...
                                  GError **error)
{
  g_assert (RTFM_GIR_IS_ENUMERATION (user_data));
  g_assert (context != NULL);
  g_assert (element_name != NULL);
...
static gboolean
rtfm_gir_enumeration_ingest (RtfmGirParserObject *object,
                             ...
                             GError **error)
{
  ...
  const gchar *glib_error_domain = NULL;
  ...
  if (!rtfm_gir_g_markup_collect_attributes (element_name, attribute_names, attribute_values, error,
                                             ...
                                             G_MARKUP_COLLECT_STRING | G_MARKUP_COLLECT_OPTIONAL, "glib:error-domain", &glib_error_domain,
  ...
  self->glib_error_domain = rtfm_gir_parser_context_intern_string (parser_context, glib_error_domain);
...
static void
rtfm_gir_enumeration_printf (RtfmGirParserObject *object,
                             GString *str,
                             guint depth)
{
  RtfmGirEnumeration *self = (RtfmGirEnumeration *)object;
  ...
  for (i = 0; i < depth; i++)
    g_string_append (str, "  ");
  g_string_append (str, "<enumeration");
  ...
  if (self->glib_error_domain != NULL)
    g_string_append_printf (str, " glib:error-domain=\"%s\"", self->glib_error_domain);
                                   ...
                                   GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_GLIB_ERROR_DOMAIN:
      g_value_set_string (value, self->glib_error_domain);
      break;
                                   ...
                                   GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_GLIB_ERROR_DOMAIN:
      self->glib_error_domain = rtfm_gir_parser_context_intern_string (context, g_value_get_string (value));
      break;
...
rtfm_gir_enumeration_class_init (RtfmGirEnumerationClass *klass)
{
  ...
  parent_class->ingest = rtfm_gir_enumeration_ingest;
  parent_class->printf = rtfm_gir_enumeration_printf;
  parent_class->get_children = rtfm_gir_enumeration_get_children;
  ...
  properties [PROP_GLIB_ERROR_DOMAIN] =
    g_param_spec_string ("glib-error-domain",
                         "glib-error-domain",
                         "glib-error-domain",
                         NULL,
                         (G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
...
const gchar *
rtfm_gir_enumeration_get_introspectable (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);

  return self->introspectable;
}

const gchar *
rtfm_gir_enumeration_get_deprecated (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);
...
const gchar *
rtfm_gir_enumeration_get_deprecated_version (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);
...
const gchar *
rtfm_gir_enumeration_get_version (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);
...
const gchar *
rtfm_gir_enumeration_get_stability (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);
...
const gchar *
rtfm_gir_enumeration_get_name (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);
...
const gchar *
rtfm_gir_enumeration_get_c_type (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);
...
const gchar *
rtfm_gir_enumeration_get_glib_type_name (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);
...
const gchar *
rtfm_gir_enumeration_get_glib_get_type (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);
...
const gchar *
rtfm_gir_enumeration_get_glib_error_domain (RtfmGirEnumeration *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ENUMERATION (self), NULL);

  return self->glib_error_domain;
}

RtfmGirEnumeration *
rtfm_gir_enumeration_new (RtfmGirParserContext *parser_context)
{
  return g_object_new (RTFM_GIR_TYPE_ENUMERATION,
