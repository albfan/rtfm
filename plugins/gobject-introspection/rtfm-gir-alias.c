...
G_DEFINE_TYPE (RtfmGirAlias, rtfm_gir_alias, RTFM_GIR_TYPE_PARSER_OBJECT)
...
static GPtrArray *
rtfm_gir_alias_get_children (RtfmGirParserObject *object)
{
  RtfmGirAlias *self = (RtfmGirAlias *)object;

  g_assert (RTFM_GIR_IS_ALIAS (self));
...
rtfm_gir_alias_end_element (GMarkupParseContext *context,
                            ...
                            GError **error)
{
  g_assert (RTFM_GIR_IS_ALIAS (user_data));
  g_assert (context != NULL);
  g_assert (element_name != NULL);
...
static gboolean
rtfm_gir_alias_ingest (RtfmGirParserObject *object,
...
static void
rtfm_gir_alias_printf (RtfmGirParserObject *object,
                       GString *str,
                       guint depth)
{
  RtfmGirAlias *self = (RtfmGirAlias *)object;
...
rtfm_gir_alias_class_init (RtfmGirAliasClass *klass)
{
  ...
  parent_class->ingest = rtfm_gir_alias_ingest;
  parent_class->printf = rtfm_gir_alias_printf;
  parent_class->get_children = rtfm_gir_alias_get_children;
...
const gchar *
rtfm_gir_alias_get_introspectable (RtfmGirAlias *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ALIAS (self), NULL);

  return self->introspectable;
}

const gchar *
rtfm_gir_alias_get_deprecated (RtfmGirAlias *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ALIAS (self), NULL);
...
const gchar *
rtfm_gir_alias_get_deprecated_version (RtfmGirAlias *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ALIAS (self), NULL);
...
const gchar *
rtfm_gir_alias_get_version (RtfmGirAlias *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ALIAS (self), NULL);
...
const gchar *
rtfm_gir_alias_get_stability (RtfmGirAlias *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ALIAS (self), NULL);
...
const gchar *
rtfm_gir_alias_get_name (RtfmGirAlias *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ALIAS (self), NULL);
...
const gchar *
rtfm_gir_alias_get_c_type (RtfmGirAlias *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_ALIAS (self), NULL);
...
RtfmGirAlias *
rtfm_gir_alias_new (RtfmGirParserContext *parser_context)
{
  return g_object_new (RTFM_GIR_TYPE_ALIAS,
