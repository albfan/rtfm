...
G_DEFINE_TYPE (RtfmGirCallback, rtfm_gir_callback, RTFM_GIR_TYPE_PARSER_OBJECT)
...
static GPtrArray *
rtfm_gir_callback_get_children (RtfmGirParserObject *object)
{
  RtfmGirCallback *self = (RtfmGirCallback *)object;

  g_assert (RTFM_GIR_IS_CALLBACK (self));
...
rtfm_gir_callback_end_element (GMarkupParseContext *context,
                               ...
                               GError **error)
{
  g_assert (RTFM_GIR_IS_CALLBACK (user_data));
  g_assert (context != NULL);
  g_assert (element_name != NULL);
...
static gboolean
rtfm_gir_callback_ingest (RtfmGirParserObject *object,
...
static void
rtfm_gir_callback_printf (RtfmGirParserObject *object,
                          GString *str,
                          guint depth)
{
  RtfmGirCallback *self = (RtfmGirCallback *)object;
...
rtfm_gir_callback_class_init (RtfmGirCallbackClass *klass)
{
  ...
  parent_class->ingest = rtfm_gir_callback_ingest;
  parent_class->printf = rtfm_gir_callback_printf;
  parent_class->get_children = rtfm_gir_callback_get_children;
...
const gchar *
rtfm_gir_callback_get_introspectable (RtfmGirCallback *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_CALLBACK (self), NULL);

  return self->introspectable;
}

const gchar *
rtfm_gir_callback_get_deprecated (RtfmGirCallback *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_CALLBACK (self), NULL);
...
const gchar *
rtfm_gir_callback_get_deprecated_version (RtfmGirCallback *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_CALLBACK (self), NULL);
...
const gchar *
rtfm_gir_callback_get_version (RtfmGirCallback *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_CALLBACK (self), NULL);
...
const gchar *
rtfm_gir_callback_get_stability (RtfmGirCallback *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_CALLBACK (self), NULL);
...
const gchar *
rtfm_gir_callback_get_name (RtfmGirCallback *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_CALLBACK (self), NULL);
...
const gchar *
rtfm_gir_callback_get_c_type (RtfmGirCallback *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_CALLBACK (self), NULL);
...
const gchar *
rtfm_gir_callback_get_throws (RtfmGirCallback *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_CALLBACK (self), NULL);
...
RtfmGirCallback *
rtfm_gir_callback_new (RtfmGirParserContext *parser_context)
{
  return g_object_new (RTFM_GIR_TYPE_CALLBACK,
