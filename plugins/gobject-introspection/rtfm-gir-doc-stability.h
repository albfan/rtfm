...
#ifndef RTFM_GIR_DOC_STABILITY_H
#define RTFM_GIR_DOC_STABILITY_H
...
const gchar *rtfm_gir_doc_stability_get_xml_whitespace (RtfmGirDocStability *self);

G_END_DECLS

#endif /* RTFM_GIR_DOC_STABILITY */
