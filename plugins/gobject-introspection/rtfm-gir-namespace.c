...
G_DEFINE_TYPE (RtfmGirNamespace, rtfm_gir_namespace, RTFM_GIR_TYPE_PARSER_OBJECT)
...
static GPtrArray *
rtfm_gir_namespace_get_children (RtfmGirParserObject *object)
{
...
rtfm_gir_namespace_end_element (GMarkupParseContext *context,
                                ...
                                GError **error)
{
  g_assert (RTFM_GIR_IS_NAMESPACE (user_data));
  g_assert (context != NULL);
  g_assert (element_name != NULL);
...
static gboolean
rtfm_gir_namespace_ingest (RtfmGirParserObject *object,
...
static void
rtfm_gir_namespace_printf (RtfmGirParserObject *object,
                           GString *str,
                           guint depth)
{
  RtfmGirNamespace *self = (RtfmGirNamespace *)object;
...
rtfm_gir_namespace_class_init (RtfmGirNamespaceClass *klass)
{
  ...
  parent_class->ingest = rtfm_gir_namespace_ingest;
  parent_class->printf = rtfm_gir_namespace_printf;
  parent_class->get_children = rtfm_gir_namespace_get_children;
...
const gchar *
rtfm_gir_namespace_get_name (RtfmGirNamespace *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_NAMESPACE (self), NULL);

  return self->name;
}

const gchar *
rtfm_gir_namespace_get_version (RtfmGirNamespace *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_NAMESPACE (self), NULL);
...
const gchar *
rtfm_gir_namespace_get_c_identifier_prefixes (RtfmGirNamespace *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_NAMESPACE (self), NULL);
...
const gchar *
rtfm_gir_namespace_get_c_symbol_prefixes (RtfmGirNamespace *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_NAMESPACE (self), NULL);
...
const gchar *
rtfm_gir_namespace_get_c_prefix (RtfmGirNamespace *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_NAMESPACE (self), NULL);
...
const gchar *
rtfm_gir_namespace_get_shared_library (RtfmGirNamespace *self)
{
  g_return_val_if_fail (RTFM_GIR_IS_NAMESPACE (self), NULL);
