...
void _rtfm_gir_parser_object_set_parent (RtfmGirParserObject *self,
                                         RtfmGirParserObject *parent) G_GNUC_INTERNAL;
RtfmGirParserObject *rtfm_gir_parser_object_get_parent (RtfmGirParserObject *self);
